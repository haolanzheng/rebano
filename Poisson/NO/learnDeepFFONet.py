...
model = DeepFFONet(r_f, 1, X_upper, layers,  layers, N_neurons) 
...
for ep in range(1, epochs+1):
    ...
    torch.save(model, "../model/DeepFFONet_width_"+str(N_neurons)+"_Nd_"+str(n_train)+"_l_"+str(layers)+"_K_"+str(K)+".model")
    scheduler.step()
